...
<div align=center><img src="https://github.com/Charmve/PaperWeeklyAI/raw/master/MaiweiAI-com.png" height="330" width="330"></div>

<div align=center size = 3><b>△微信扫一扫，关注我</b></div>
<br>

从今年三月份开始，我将开源的方向调整为机器学习、计算机视觉、深度学习、NLP、AI前沿技术动态的相关文章发布，从入门学习指导（我自己的机器学习路线总结，入过很多坑）到现在的顶会论文总结、前沿论文研读。公众号主页底部有菜单分类，欢迎关注。
